package com.project.softwareengineerinng.config;

import com.project.softwareengineerinng.filter.JwtFilter;
import com.project.softwareengineerinng.service.CustomUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeRequests()
                ...
                .antMatchers("/api/register").permitAll().anyRequest()
                .authenticated()
    ...
    private CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://maharishihotel.herokuapp.com","http://localhost:3000"));
